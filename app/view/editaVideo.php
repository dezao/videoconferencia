...
<!--                     <div class="input-field col s12">
                        Fazer a persistencia dos dados visto que o Analista não poderá ser alterado 
                        <input type="text" name="analistaResponsavel" id="analistaResponsavel" value="<?php /*echo $dadosEdita['analistaResponsavel'];*/ ?>">
